...
# Set permissions only on directories, not files (avoid -R to preserve file permissions)
chmod 755 /etc/nginx/ssl/.well-known
chmod 755 /etc/nginx/ssl/.well-known/acme-challenge
