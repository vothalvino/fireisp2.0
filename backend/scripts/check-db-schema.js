...
// Migration command constant
const MIGRATION_005_CMD = 'docker-compose exec -T postgres psql -U fireisp fireisp < database/migrations/005_add_payment_system.sql';
